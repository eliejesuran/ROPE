...
export default function ChatScreen({ conversation, onBack }: Props) {
  ...
  const handleGenerateKey = async () => {
    ...
    Alert.alert(
      ...
      `Envoyez-la à votre contact par un canal sécurisé (SMS, appel, en personne).\n\nIl devra la coller dans "Entrer une clé".\n\nLa clé est déjà copiée — vous n\'avez qu\'à coller.`,
      [
